...
class _DestinationSummaryCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    late final String pickupValue;
    late final String dropoffValue;

    if (isPickupTask) {
      pickupValue = booking.customerAddress;
      dropoffValue = _laundryAddressFromBooking(booking);
    } else if (isDeliveryTask) {
      pickupValue = _laundryAddressFromBooking(booking);
      dropoffValue = booking.customerAddress;
    } else {
      pickupValue = booking.customerAddress;
      dropoffValue = _laundryAddressFromBooking(booking);
    }
  ...
  static String _laundryAddressFromBooking(BookingModel booking) {
    return booking.laundrySnapshotAddressLine?.trim().isNotEmpty == true
        ? booking.laundrySnapshotAddressLine!.trim()
        : booking.laundrySnapshotName?.trim().isNotEmpty == true
        ? booking.laundrySnapshotName!.trim()
            ...
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  onHorizontalDragUpdate: widget.isDisabled || widget.isLoading
                      ? null
                      : (details) {
                          setState(() {
