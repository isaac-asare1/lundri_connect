...
class _OrdersScreenState extends State<OrdersScreen>
  ...
  void _handleNewOrdersChanged(List<BookingModel> bookings) {
    final currentIds = bookings.map((booking) => booking.id).toSet();

    if (!_hasLoadedInitialNewOrders) {
      _knownNewOrderIds = currentIds;
      _hasLoadedInitialNewOrders = true;
      return;
    }

    final hasNewOrder = currentIds.difference(_knownNewOrderIds).isNotEmpty;
          ...
          : TabBarView(
              ...
              children: [
                _OrdersListView(
                  ...
                  onRefresh: _refresh,
                  onOrdersChanged: _handleNewOrdersChanged,
...
class _OrdersListView extends StatelessWidget {
  ...
  final void Function(List<BookingModel> bookings)? onOrdersChanged;
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: _SlideAcceptOrderButton(
                      isLoading: _isAccepting,
                      enabled: !_isAccepting && !_isRejecting,
                      onAccepted: _handleAccept,
                    ),
                  ),
                ],
              ),
              ...
              Positioned(
                ...
                child: GestureDetector(
                  ...
                  onHorizontalDragEnd: widget.enabled && !widget.isLoading
                      ? (_) async {
                          final shouldAccept = knobLeft > maxTravel * 0.65;
