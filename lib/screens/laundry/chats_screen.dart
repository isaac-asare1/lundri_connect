...
//   String get _senderId => _currentUserId;
//   String get _receiverId =>
//       _isLaundry ? widget.booking.customerId : widget.booking.laundryId;

//   String get _senderName {
//     if (_isLaundry) {
//       return widget.booking.laundryName.trim().isEmpty
//           ? 'Laundry'
//           : widget.booking.laundryName;
//     }
...
//         if (bottomChanged && _isNearBottom) {
//           WidgetsBinding.instance.addPostFrameCallback((_) {
//             _scrollToBottom();
//           });
//         }
...
//         .where((m) => m.senderId != _currentUserId && !m.isRead && !m.isDeleted)
//         .map((m) => m.id)
//         .toList();
...
//     if (text.isEmpty && _pickedImageFile == null && _pickedVideoFile == null) {
//       return;
//     }
...
//     batch.update(_bookingRef(bookingId), {
...
//       return senderRole == 'laundry' ? '📷 Sent an image' : '📷 Sent an image';
//     }
//     if (type == LaundryChatMessageType.video) {
//       return senderRole == 'laundry' ? '🎥 Sent  a video' : '🎥 Sent a video';
//     }
...
//                 MaterialPageRoute(
//                   builder: (_) =>
//                       _FullScreenImageViewer(imagePath: message.mediaUrl!),
//                 ),
//               );
//             },
//             child: ClipRRect(
...
//                           message.messageType == LaundryChatMessageType.system
//                       ? 16
//                       : 8,
//                   message.messageType == LaundryChatMessageType.text ||
//                           message.messageType == LaundryChatMessageType.system
...
class _LaundryChatScreenState extends State<LaundryChatScreen> {
  ...
  String get _receiverRole => _isLaundry ? 'customer' : 'laundry';
  String get _bookingId => widget.booking.id;
  String get senderId => widget.booking.laundryId;
