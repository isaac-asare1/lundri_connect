...
class BookingModel {
  ...
  factory BookingModel.fromMap(Map<String, dynamic> map, String docId) {
    ...
    final GeoPoint? pickupGeoPoint = _readGeoPoint(
      pickupAddressMap['geopoint'],
    );

    final GeoPoint? customerAddressGeoPoint = _readGeoPoint(
      customerAddressMap['geopoint'],
    );
    ...
    return BookingModel(
      ...
      pickupAddress: _readString(pickupAddressMap['addressLine']),
      pickupSubtitle: _readString(pickupAddressMap['subtitle']),
      pickupLatitude: pickupGeoPoint?.latitude,
      pickupLongitude: pickupGeoPoint?.longitude,

      customerAddress: _readString(customerAddressMap['addressLine']),
      deliverySubtitle: _readString(customerAddressMap['subtitle']),
      deliveryLatitude: customerAddressGeoPoint?.latitude,
      deliveryLongitude: customerAddressGeoPoint?.longitude,
      isSameAsPickup: _readBool(customerAddressMap['isSameAsPickup']),
